    ...
    const fetchData = async () => {
      try {
        const [titleResponse, genreResponse, actorResponse] = await Promise.all([
          fetch(`https://localhost/api/movie/${titleId}`), // First fetch
          fetch(`https://localhost/api/movie/${titleId}/genre`), // Second fetch
          fetch(`https://localhost/api/movie/${titleId}/actors`), // Third fetch
        ]);
