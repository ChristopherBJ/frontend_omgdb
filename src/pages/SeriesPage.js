...
const SeriesPage = () => {
  ...
  const handleRatingSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setRatingStatus('You already rated this series.');
      } else {
  ...
  const fetchUserWatchlist = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setWatchlistStatus('Watchlisted'); // If series is in watchlist, set status
      } else if (response.status === 404) {
        setWatchlistStatus('Add to Watchlist'); // series is not in watchlist
      } else {
      ...
      <div className="content">
        ...
        <div className="details">
          ...
          <div className="rating">
            <p>Your rating on this series:</p>
