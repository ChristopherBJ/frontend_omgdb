    ...
    const fetchData = async () => {
      try {
        const [titleResponse, genreResponse, actorResponse] = await Promise.all([
          fetch(`https://localhost/api/episode/${titleId}`), // First fetch
          fetch(`https://localhost/api/episode/${titleId}/genre`), // Second fetch
          fetch(`https://localhost/api/episode/${titleId}/actors`), // Third fetch
        ]);
